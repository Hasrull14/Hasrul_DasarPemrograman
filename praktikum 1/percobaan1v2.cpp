...
int main() {
    ...
    string berita = "CNN Indonesia", kasus_berita = "korupsi", perusahaan = "PT Pertamina";
    string tanggal_pemeriksaan = "28 Februari 2025", hari_pemeriksaan = "Jumat";
    string nama_presiden = "Prabowo", tempat_penggeledahan = "Cilegon", tempat_berita = "Jakarta";
    
    int jumlah_tersangka = 9;
    double jumlah_kerugian = 193.7;
    ...
    cout << "Jumlah Kerugian Negara: " << fixed << setprecision(1) << jumlah_kerugian << " miliar" << endl;

    // Mencegah program langsung tertutup
    cin.get(); 
    return 0;
}
